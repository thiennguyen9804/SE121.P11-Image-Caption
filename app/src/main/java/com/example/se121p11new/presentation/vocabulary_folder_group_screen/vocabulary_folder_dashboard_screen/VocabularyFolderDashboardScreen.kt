...
@Composable
fun VocabularyFolderDashboardScreen(
    onFolderCreate: (String) -> Unit,
    onGoToVocabularyFolder: () -> Unit,
    onGoToAllSavedVocabulary: () -> Unit,
) {
        ...
        Column {
            IconButton(
                ...
                Row(
                    ...
                    Spacer(modifier = Modifier.width(10.dp))
                    Text(text = stringResource(R.string.saved_vocabulary_text))
                }
            }
            ...
            IconButton(
                ...
                Row(
                    ...
                    Spacer(modifier = Modifier.width(10.dp))
                    Text(text = stringResource(R.string.created_vocabulary_folder_text))
                }
            }
            Spacer(modifier = Modifier.height(10.dp))
        }
